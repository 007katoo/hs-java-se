 ...
 * {@code MyAbstractQueuedSynchronizer} does not implement any
 ...
 * {@code MyAbstractQueuedSynchronizer} method otherwise creates such a
 ...
 * using an {@code MyAbstractQueuedSynchronizer} for their
...
public abstract class MyAbstractQueuedSynchronizer
    ...
    /**
     * Creates a new {@code MyAbstractQueuedSynchronizer} instance
    ...
    /**
     * 当前线程尝试获取锁，若获取成功，则加锁流程完成完成；若第一次获取不成功，则新建Node节点，将当前线程的保存到节点中，添加新建的节点到双向链表中；
     * 若此时线程对应的节点，其前一个节点若为头节点，那么让此线程继续尝试获取锁；否则，当且仅当当前线程的前一节点的waitStatus==-1，设置当前线程等待
     */
     ...
     * avoid <a href="MyAbstractQueuedSynchronizer#barging">barging</a>.
